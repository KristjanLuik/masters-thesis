...
\newcommand{\thesisTitleEng}{Logging detection using vision foundation models} % variable with thesis title
\newcommand{\thesisTitleEst}{Metsaraie tuvastamine rakendades arvutinägemise alusmudeleid} % Title in Estonian
...
\newcommand{\signatureDate}{12.05.2025}

% PDF Metadata
\newcommand{\version}{0.1 version}
\newcommand{\keywords}{alusmudelid, metsaraie, SAMv2, DINOv2, sateliidi pildid} % Keywords for the thesis
