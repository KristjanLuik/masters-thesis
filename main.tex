...
\newcommand{\thesisTitleEng}{Logging detection using the Dinov2 vision model} % variable with thesis title
\newcommand{\thesisTitleEst}{Metsaraie tuvastamine rakendades nägemise alusmudelit Dinov2} % Title in Estonian
