...
\input{chapters/sissejuhatus} %  This command inserts the content from the file introduction.tex located in the chapters folder.

\chapter{Valdkonna ülevaade}\label{chapter:taust}
\input{chapters/taust.tex}

\chapter{Lahendus}\label{chapter:lahendus}
\input{chapters/lahendus.tex}

\chapter{Tulemuste analüüs}\label{chapter:analüüs}
\input{chapters/analüüs.tex}
