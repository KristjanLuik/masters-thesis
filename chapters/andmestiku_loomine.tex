...
Peale selle etapi lõppu, kus on loodud 100 raie ümbrust, kuid need on polügoonidena. Edasi kirjeldatakse lahti sammud, välja toodud joonisel \ref{fig:terveflow}, et saada nendega seonduvad satelliidi pildid.
...
laiendati ajavahemikku ning tõsteti lubatavat pilvekatte protsenti kuni eelnevalt
...
Selles peatükis käsitletakse andmete maskimist, kuna metsaregistrist saadud andmed pole piisavalt täpsed, et neid otse kasutada masinõppes, siis sai loodud sammud, et neid täpsemaks muuta. Terviklik dokument on  töö lisade hulgas.
